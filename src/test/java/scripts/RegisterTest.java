...
public class RegisterTest extends BaseTest {
    ...
    @Test(priority = 13,dataProvider = "csvInvalidName",
    ...
    @Test(priority = 14,dataProvider = "csvInvalidEmail",
    ...
    @Test(priority = 15,dataProvider = "csvInvalidPassword",
    ...
    @Test(priority = 16,dataProvider = "csvInvalidPhone",
    ...
    @Test(priority = 17,dataProvider = "csvInvalidBirthday",
