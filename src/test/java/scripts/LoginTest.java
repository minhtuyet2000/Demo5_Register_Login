...
public class LoginTest extends BaseTest {
    ...
    public void testInteractLogin() {
        loginPage = new LoginPage(DriverManager.getDriver());
        loginPage.interactLogin("minh123%@gmail.com"," Tyt @12 ");
        WebUI.assertAll();
    }
    ...
    public void testErrorSpaceEmail() {
        loginPage = new LoginPage(DriverManager.getDriver());
        loginPage.verifyErrorSpaceEmail("        "," Tyt @12 ","Email không đúng định dạng !");
        WebUI.assertAll();
    }
    ...
    public void testErrorSpacePassword() {
        loginPage = new LoginPage(DriverManager.getDriver());
        loginPage.verifyInvalid("minh123%@gmail.com","        ","Email hoặc mật khẩu không đúng !");
        WebUI.assertAll();
    }
    ...
    public void testInvalidEmail(String email) {
        loginPage = new LoginPage(DriverManager.getDriver());
        loginPage.verifyInvalid(email," Tyt @12 ","Email hoặc mật khẩu không đúng !");
        WebUI.assertAll();
    }
    ...
    public void testInvalidPassword(String password) {
        loginPage = new LoginPage(DriverManager.getDriver());
        loginPage.verifyInvalid("minh123%@gmail.com",password+" ","Email hoặc mật khẩu không đúng !");
        WebUI.assertAll();
    }
    ...
    @Test(priority = 13,dataProvider = "randomInvalidLogin",
            description = "Kiểm tra đăng nhập that bai với email và password không hop le", groups = {"LoginTest"})
    public void testInvalidLogin(String email, String password) {
        loginPage = new LoginPage(DriverManager.getDriver());
        loginPage.verifyInvalidLogin(email,password,
